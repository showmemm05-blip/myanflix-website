...
const en = {
  ...
  /** Shared comment section on the movie and series detail pages. UI only for now — nothing is sent anywhere. */
  comments: {
    heading: "Comments",
    ...
    you: "You",
    justNow: "Just now",
    notWiredUp: "Preview only — comments aren't saved yet.",
  },
  footer: {
  ...
  profile: {
    ...
    stubNotice: "This isn't connected to the backend yet.",
...
const mm = {
  ...
  comments: {
    ...
    you: "သင်",
    justNow: "ယခုလေးတင်",
    notWiredUp: "အစမ်းပြသမှုသာ — မှတ်ချက်များကို မသိမ်းဆည်းရသေးပါ။",
  },
  footer: {
  ...
  profile: {
    ...
    stubNotice: "ဤလုပ်ဆောင်ချက်သည် backend နှင့် မချိတ်ဆက်ရသေးပါ။",
